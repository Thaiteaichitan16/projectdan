                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        ...
                        <td><span class="badge bg-label-primary me-1">{{$item->TahunTerbit}}</span></td>
                        <td>{{$item->Stok}}</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{url('edit/'.$item->BukuID)}}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="hapus/{{$item->BukuID}}"
