...
>
  <head>
    ...
    <title>Data Kategori Relasi</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tabel /</span> Data Kategori Relasi</h4>
            
             <!-- Basic Bootstrap Table -->
             <div class="card">
              <div class="demo-inline-spacing d-flex justify-content-end mx-2">
                <a href="{{url('tambahrelasi')}}"><button type="button" class="btn btn-outline-primary">Tambah</button></a>
              </div>
              <div class="text-nowrap">
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                      <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$item->BukuID}}</strong></td>
                      <td>
                     ...
                     <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{url('redit/'.$item->KategoriBukuID)}}"
                              ><i class="bx bx-edit-alt me-1"></i> Edit</a
                            >
                            <a class="dropdown-item" href="rhapus/{{$item->KategoriBukuID}}"
